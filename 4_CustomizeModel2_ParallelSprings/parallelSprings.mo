...
equation
  connect(flange_a, spring.flange_a) annotation(
    Line(points = {{-104, 0}, {-40, 0}, {-40, 20}, {-10, 20}, {-10, 20}}, color = {0, 127, 0}));
...
annotation(
    ...
    Icon(graphics = {Rectangle(fillColor = {255, 170, 0}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {2, 0}, extent = {{-98, 36}, {98, -36}}, textString = "ParallelSprings")}));
end ParallelSprings;
