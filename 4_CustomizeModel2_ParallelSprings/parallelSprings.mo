...
annotation(
    ...
    Icon(graphics = {Rectangle(fillColor = {255, 170, 0}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-10, 8}, extent = {{-74, 24}, {98, -36}}, textString = "ParallelSprings")}, coordinateSystem(initialScale = 0.1)));
end ParallelSprings;
